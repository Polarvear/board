...
class JobsController extends Controller
{
  ...
  public function __construct(jobs $jobs, comments $comments){
      // Laravel 의 IOC(Inversion of Control) 입니다
      // 일단은 이렇게 모델을 가져오는 것이 추천 코드라고 생각하시면 됩니다.
      $this->jobs = $jobs;
      $this->comments = $comments;
  }
  public function index(Request $request, jobs $jobs, comments $comments){
    ...
    return view('products.user-info', ['data' => $data, 'comments' => $comments]);
  }
